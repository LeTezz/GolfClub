...
<div id="page-container" class="row">
		...
		<div class="actions">
                ...
                <div class="dropdown">
                    <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown"><?=__('Clubs')?>
                        <span class="caret"></span></button>
                    <ul class="dropdown-menu">
                        <li class="list-group-item"><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Club.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Club.id'))); ?></li>
                        <li class="list-group-item"><?php echo $this->Html->link(__('List Clubs'), array('action' => 'index')); ?></li>
	...
	<div id="page-content" class="col-sm-9">
		...
		<h2><?php echo __('Edit Club'); ?></h2>

		<div class="clubs form">
		
			<?php echo $this->Form->create('Club', array('role' => 'form')); ?>
				...
				<fieldset>
					...
					<div class="form-group">
						<?php echo $this->Form->input('year_established', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
