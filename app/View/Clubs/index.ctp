...
<?php foreach ($clubs as $club): ?>
	<tr>
		...
		<td><?php echo h($club['Club']['name']); ?>&nbsp;</td>
                <?php if ($this->Session->read('Auth.User.active')): ?>
		<td><?php echo h($club['Club']['year_established']); ?>&nbsp;</td>
		<td><?php echo h($club['Club']['address']); ?>&nbsp;</td>
		
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $club['Club']['id']), array('class' => 'btn btn-default btn-xs')); ?>
                    <?php if ($this->Session->read('Auth.User.role') == "admin" || $this->Session->read('Auth.User.id') == $club['Club']['user_id']  ): ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $club['Club']['id']), array('class' => 'btn btn-default btn-xs')); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $club['Club']['id']), array('class' => 'btn btn-default btn-xs'), __('Are you sure you want to delete # %s?', $club['Club']['id'])); ?>
		</td><?php endif ?>
                <?php endif ?>
	</tr>
<?php endforeach; ?>
